...
import (
	...
	"github.com/shohagrana64/crd/pkg/client/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type StableV1alpha1Interface interface {
	RESTClient() rest.Interface
	DisappointmentsGetter
}
...
func (c *StableV1alpha1Client) Disappointments(namespace string) DisappointmentInterface {
	return newDisappointments(c, namespace)
}
...
func setConfigDefaults(config *rest.Config) error {
	gv := v1alpha1.SchemaGroupVersion
